...
def describe_get_in():
    ...
    def test_without_specified_default_value(collection, path, expected):
    ...
    def test_with_specified_default_value(collection, path, default, expected):
        assert get_in(collection, path, default) == expected


def describe_require_in():
    TESTS_THAT_RAISES = {
